...
INT vht_mode_adjust(RTMP_ADAPTER *pAd, MAC_TABLE_ENTRY *pEntry, VHT_CAP_IE *cap, VHT_OP_IE *op)
{
	...
	if (pAd->CommonCfg.Channel > 14 && pEntry->MaxHTPhyMode.field.BW > BW_40) {
		...
		UCHAR BAD_IPHONE6_12_OUI[]  = {0x98, 0x9e, 0x63};
		UCHAR BAD_IPHONE6_13_OUI[]  = {0xC0, 0xE8, 0x62};
		UCHAR BAD_IPHONE6_14_OUI[]  = {0xA8, 0x5C, 0x2C};
		UCHAR BAD_IPHONE6_15_OUI[]  = {0xD8, 0x8F, 0x76};
		UCHAR BAD_IPHONE6_16_OUI[]  = {0x54, 0x9F, 0x13};
		...
		UCHAR BAD_MACBOOK_5_OUI[]  = {0xF4, 0x0F, 0x24};
		UCHAR BAD_MACBOOK_6_OUI[]  = {0x80, 0xE6, 0x50};
		...
		if (NdisEqualMemory(pEntry->Addr, BAD_MACBOOK_1_OUI, 3)
			    ...
			    || NdisEqualMemory(pEntry->Addr, BAD_IPHONE6_12_OUI, 3)
			    || NdisEqualMemory(pEntry->Addr, BAD_IPHONE6_13_OUI, 3)
			    || NdisEqualMemory(pEntry->Addr, BAD_IPHONE6_14_OUI, 3)
			    || NdisEqualMemory(pEntry->Addr, BAD_IPHONE6_15_OUI, 3)
			    || NdisEqualMemory(pEntry->Addr, BAD_IPHONE6_16_OUI, 3)
